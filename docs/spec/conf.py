...
htmlhelp_basename = 'RushHour doc'
...
latex_documents = [
    (master_doc, 'RushHour.tex', 'RushHour Documentation',
     'yasshi2525', 'manual'),
]
...
man_pages = [
    (master_doc, 'RushHour', 'RushHour Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RushHour', 'RushHour Documentation',
     author, 'RushHour', 'One line description of project.',
     'Miscellaneous'),
]
