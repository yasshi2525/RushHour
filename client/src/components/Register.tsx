...
export default function(props: Attributes) {
  ...
  const succeeded = useSelector<RushHourStatus, boolean>(
    state => state.isRegisterSucceeded
  );
  ...
  return (
    <>
      ...
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle id="modal-title">新規ユーザ登録</DialogTitle>
        <Divider />
        <DialogContent>
          <form
            action="/"
                ...
                <Container className={classes.lineColor}>
                  <Box className={classes.sliderBox}>
                    ...
                    <img
                      ...
                      src={`/assets/bundle/spritesheet/color@${window.devicePixelRatio}x.png`}
                    />
                  </Box>
                  <Box className={classes.sampleBox}>
                    <div
                      ...
                      style={{
                        backgroundColor: `rgb(${hueToRgb(props.hue).join(",")})`
                      }}
                    />
                  </Box>
                </Container>
