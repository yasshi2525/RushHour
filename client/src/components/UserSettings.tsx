...
export default function() {
  ...
  const settings = useSelector<RushHourStatus, AccountSettings | undefined>(
    state => state.settings
  );
  const waitingFor = useSelector<RushHourStatus, Entry | undefined>(
    state => state.waitingFor
  );
        ...
        <Box marginRight="auto">
          ...
          >
            {editingName ? (
              ...
              <>
                <EditIcon
                  color={waitingFor === undefined ? "primary" : undefined}
                />
  ...
  return (
    <>
      ...
      <Dialog
        ...
        onClose={handleClose}
      >
        <DialogTitle id="modal-title">アカウント設定</DialogTitle>
        <Divider />
        <DialogContent>
          {settings === undefined ? (
                      ...
                      <>
                        <FormControlLabel
                          ...
                          label={
                            <Box display="flex" alignItems="center">
                              <Typography>
                                {settings.auth_type} のアカウント名を使用する
                              </Typography>
                              {waitingFor !== undefined &&
                                waitingFor.key == use_cname && (
                                  <Box marginRight="auto">
                                    <CircularProgress
                        ...
                        <Paper className={classes.value}>
                          <Typography
                            className={
                              settings.use_cname ? classes.disable : undefined
                            }
                          >
                            {settings.oauth_name}
                          </Typography>
