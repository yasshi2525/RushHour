import { Point, getChunkByPos } from "common/interfaces/gamemap";
import {
  startMonitor,
  MonitorContainer,
  Monitorable
} from "common/interfaces/monitor";
...
export default abstract class {
  ...
  getOnChunk(
    ...
    return this.containers[key].getChildOnChunk(
      getChunkByPos(pos, this.model.coord.scale - this.model.delegate + 1),
      oid
    );
  }
