...
export abstract class ZoomablePointModel extends PointModel implements Monitorable {
    ...
    resolve(error: ResolveError) {
        ...
        if (resourceName !== undefined) {
            let parent = this.model.gamemap.get(resourceName, this.props.pid) as PointModel | undefined;
            if (parent !== undefined) {
...
export abstract class ZoomablePointModelContainer<T extends ZoomablePointModel> extends PointContainer<T> implements MonitorContainer {
