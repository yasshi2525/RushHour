...
export function* generateMap(action: ReturnType<typeof Action.fetchMap.request>) {
    return yield generateRequest(() => fetchMap(action.payload.model), action, Action.fetchMap);
}
