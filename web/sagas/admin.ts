...
export function* generatePurgeUserData(action: ReturnType<typeof Action.purgeUserData.request>) {
    return yield generateRequest(() => purgeUserData(), action, Action.purgeUserData);
}